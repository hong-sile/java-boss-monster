...
public class OutputView {
  ...
  private static final String DAMAGE_FORMAT = " (입힌 데미지: 20)";
  ...
  public void printGameProgressMessage(
      final GameStatusResponse statusResponse
  ) {
  ...
  public void printEndGameMessage(final int round, final String userName) {
